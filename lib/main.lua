...
local library = {
    ...
    images = {
        ['gradientp90'] = 'https://raw.githubusercontent.com/diaryyyy/Poems/refs/heads/main/lib/gradient90.png';
        ['gradientp45'] = 'https://raw.githubusercontent.com/diaryyyy/Poems/refs/heads/main/lib/gradient45.png';
        ['colorhue'] = 'https://raw.githubusercontent.com/diaryyyy/Poems/refs/heads/main/lib/lgbtqshit.png';
        ['colortrans'] = 'https://raw.githubusercontent.com/diaryyyy/Poems/refs/heads/main/lib/trans.png';
    };
    numberStrings = {['Zero'] = 0, ['One'] = 1, ['Two'] = 2, ['Three'] = 3, ['Four'] = 4, ['Five'] = 5, ['Six'] = 6, ['Seven'] = 7, ['Eight'] = 8, ['Nine'] = 9};
    signal = loadstring(game:HttpGet('https://raw.githubusercontent.com/diaryyyy/Poems/refs/heads/main/lib/Signal.lua'))();
    open = false;
    opening = false;
    hasInit = false;
...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "yzdp"})
    creditsSection:AddText({text = "schizophrenicfuck"})
